            ...
            <div className="flex mt-3">
              <div className="relative flex-1 mr-2">
                <input
                  ...
                  className="w-full rounded-l-full py-2 px-4 border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-pop-pink"
                />
                <Button
                  type="button"
                  onClick={addImageUrl}
                  className="absolute right-0 top-0 bottom-0 rounded-l-none rounded-r-full"
                >
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-custom p-4 shadow-soft">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start">
              <span className="bg-pop-pink text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">1</span>
              <p>Be kind and respectful to other collectors.</p>
            </li>
            <li className="flex items-start">
              <span className="bg-pop-pink text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">2</span>
              <p>Only post authentic PopMart collectibles.</p>
            </li>
            <li className="flex items-start">
              <span className="bg-pop-pink text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">3</span>
              <p>No selling or advertising. Trading is encouraged!</p>
            </li>
            <li className="flex items-start">
              <span className="bg-pop-pink text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">4</span>
              <p>Share your collection milestones and achievements.</p>
            </li>
            <li className="flex items-start">
              <span className="bg-pop-pink text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mr-2 mt-0.5">5</span>
        ...
        <div className="bg-white rounded-custom p-4 shadow-soft">
          ...
          <div className="space-y-4">
            <div className="border border-gray-100 rounded-custom p-3">
              <div className="font-medium">PopMart Online Convention</div>
              <div className="text-xs text-gray-500 mt-1">July 15-16, 2023 • Virtual</div>
            ...
            <div className="border border-gray-100 rounded-custom p-3">
              ...
              <div className="text-xs text-gray-500 mt-1">August 3, 2023 • Global</div>
