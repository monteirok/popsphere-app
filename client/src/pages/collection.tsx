  ...
  return (
    <div className="bg-white rounded-custom p-4 shadow-soft">
      <div className="flex items-center justify-between mb-4">
        ...
        <a href="/trades" className="text-pop-pink text-sm font-medium">View All</a>
      </div>
      ...
      {isLoading ? (
        ...
        pendingTrades.map((trade: any) => (
          <div key={trade.id} className="trade-card bg-gray-50 rounded-custom p-3 mb-3 transition-transform duration-200 cursor-pointer">
            <div className="flex items-center mb-2">
              ...
              {new Date(trade.createdAt).getTime() > Date.now() - 86400000 && (
                <div className="ml-auto text-xs bg-soft-blue text-white px-2 py-0.5 rounded-full">New</div>
              )}
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="px-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-pop-pink">
      ...
      <div className="text-center p-2">
        <a href="/trades" className="text-gray-500 text-sm hover:text-pop-pink">Create New Trade Request</a>
      </div>
    </div>
  );
}
